...
export default function App() {
 ...
 useEffect(()=>{
  const fetchData = async ()=>{
    try{
      const response = await axios.get("https://artinet-server.vercel.app/api/fetch");
  ...
  const handleDisplay = async(e)=>{
    e.preventDefault();
     ...
     try{
      const response = await axios.post("https://artinet-server.vercel.app/api/posts", {write, title});
